  ...
  return (
    <aside style={styles.sidebar}>
      <div style={styles.brand}>
        ...
        <span style={styles.brandName}>MailMind</span>
      </div>
      ...
      <nav style={styles.nav}>
        {NAV_ITEMS.map((item) => {
          ...
          return (
            ...
            >
              <span style={{ color: active ? "#6366F1" : "#9CA3AF" }}>{item.icon}</span>
              <span style={{ ...styles.navLabel, color: active ? "#1A1A2E" : "#6B7280" }}>
                {item.label}
              </span>
            </button>
          );
...
const styles = {
  sidebar: { width: "220px", minHeight: "100vh", background: "white", borderRight: "1px solid #F3F4F6", display: "flex", flexDirection: "column", padding: "24px 16px", flexShrink: 0 },
  ...
  brandName: { fontSize: "17px", fontWeight: "700", color: "#1A1A2E", letterSpacing: "-0.3px", fontFamily: "Georgia, serif" },
  ...
  navItemActive: { background: "#F5F3FF" },
  ...
  logoutText: { fontSize: "14px", color: "#9CA3AF", fontFamily: "system-ui, sans-serif" },
};
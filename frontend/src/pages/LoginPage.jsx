...
const styles = {
  ...
  card: {
    ...
    width: "100%",
    maxWidth: "420px",
    boxShadow: "0 1px 3px rgba(0,0,0,0.06), 0 20px 60px rgba(0,0,0,0.08)",
    position: "relative",
    zIndex: 1,
  },
  brand: {
  ...
  brandName: {
    fontSize: "clamp(16px, 4vw, 20px)", fontWeight: "700", color: "#1A1A2E", letterSpacing: "-0.5px",
  },
  headline: { marginBottom: "24px" },
  title: {
    fontSize: "clamp(22px, 6vw, 28px)", fontWeight: "700", color: "#1A1A2E",
    lineHeight: "1.3", margin: "0 0 10px 0", letterSpacing: "-0.5px",
  },
  subtitle: {
  ...
  featureText: { fontSize: "13px", color: "#4B5563", fontFamily: "system-ui, sans-serif" },
  ...
  googleBtn: {
    ...
    boxShadow: "0 1px 3px rgba(0,0,0,0.06)", fontFamily: "system-ui, sans-serif",
  },
  disclaimer: {
    textAlign: "center", fontSize: "11px", color: "#9CA3AF",
    marginTop: "14px", fontFamily: "system-ui, sans-serif",
  },
};